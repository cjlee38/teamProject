  ...
  render() {
    ...
    if (displayLecture) {
      ...
      return (
        ...
        <td className={"test"} style={required ? { backgroundColor: '#FF5675' } : subject ? { backgroundColor: this.state.color3} : { backgroundColor: this.state.color2, opacity:this.state.opacity2}}  >
